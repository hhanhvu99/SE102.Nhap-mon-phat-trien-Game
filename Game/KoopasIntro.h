...
#define ENEMY_KOOPAS_MOVE_SPEED_X		0.03f
#define ENEMY_KOOPAS_MOVE_SPEED_FAST	0.05f
#define ENEMY_KOOPAS_ROLL_SPEED_DEFLECT	0.07f
#define ENEMY_KOOPAS_ROLL_SPEED_X		0.22f
#define ENEMY_KOOPAS_ROLL_SPEED_SLOW	0.15f
