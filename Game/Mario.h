...
//Speed
#define MARIO_WALKING_SPEED				0.005f 
#define MARIO_RUNNING_SPEED				0.001f 
#define MARIO_JUMPING_SPEED				0.035f
#define MARIO_MAX_WALKING_SPEED			0.1f
#define MARIO_MAX_RUNNING_SPEED			0.2f
#define MARIO_SLIDE_SPEED				0.002f
#define MARIO_BREAK_SPEED				0.005f
#define MARIO_RUNNING_BREAK_SPEED		0.01f

#define MARIO_JUMP_SPEED_Y				0.5f
#define MARIO_JUMP_DEFLECT_SPEED		0.2f
#define MARIO_GRAVITY					0.015f
